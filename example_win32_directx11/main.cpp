...
int main(int, char**)
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"ImGui menu", WS_POPUP, 0, 0, 1920, 1080, NULL, NULL, wc.hInstance, NULL);
    ...
    while (!done)
    {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::Begin("General", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoBringToFrontOnFocus);
            {
                ...
                draw->AddText(center_text(p, p + ImVec2(827, 52), "Fujiwara menyoo"), ImColor(1.f, 1.f, 1.f, 1.f), "Fujiwara menyoo");
